    ...
    <div className="space-y-5">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          <Role label="Owner / Admin" description="See every sidebar page and manage all groups, meetings, guests, checklist items, and permissions." />
          <Role label="Group Manager" description="Can create and edit groups. Cannot view Guest Review, Permissions, or the CCB Checklist. Meeting access is limited to groups they personally lead." />
          <Role label="Group Leader" description="Can open and manage meetings only for groups where their CCB individual ID matches the group's main leader ID." />
